              ...
              <div className="p-4 space-y-4">
                ...
                <div className="rocket-card p-4">
                  ...
                  <button
                    ...
                    className="w-full p-3 bg-muted/30 rounded-lg hover:bg-muted/50 transition-colors text-sm font-medium"
                  >
                    Edit Profile
                  </button>
                </div>
        ...
        <div className="flex-1 min-h-screen">
          <div className="max-w-md mx-auto px-6">
            ...
            <div className="space-y-6 p-4">
              ...
              {/* Navigation Tabs */}
              <div className="flex bg-background/80 rounded-lg p-1 border border-border/20">
                <button
              ...
              {activeTab === "create" && (
                <div className="space-y-4">
                  <div className="text-left">
                    ...
                    <p className="text-sm text-muted-foreground">Design and launch your own challenge</p>
                  </div>
                  <div className="rocket-card p-6 text-center">
                    <div className="w-16 h-16 mx-auto bg-primary/10 rounded-full flex items-center justify-center mb-4">
                      <Plus className="w-8 h-8 text-primary" />
                    </div>
                    <h3 className="text-lg font-bold mb-2">Ready to Create?</h3>
                    <p className="text-sm text-muted-foreground mb-4">
                      Start building an engaging challenge for your team to participate in.
                    </p>
                    <button
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs text-muted-foreground mt-1">
                                  ...
                                  <div className="flex items-center gap-1 whitespace-nowrap">
                                    ...
                                    <span>{challenge.avgPoints} avg pts</span>
                                  </div>
                                </div>
                              </div>
                            </div>
